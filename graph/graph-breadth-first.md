...
Write a breadth first traversal method which takes a graph as its unique input. Return a collection of nodes in the order they were visited. Display the collection.
